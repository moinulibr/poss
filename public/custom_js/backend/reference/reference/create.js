    ...
    $(document).on('click','.addReferenceModal',function(){
        var url = $('.addReferenceModalRoute').val();
        ...
        */
        ...
        $.ajax({
            ...
            success:function(response){
                $('#addReferenceModal').html(response).modal('show');
    ...
    $(document).on("submit",'.storeReferenceData',function(e){
        e.preventDefault();
        var form = $(this);
            ...
            success: function(response){
                ...
                else if(response.status == true)
                {
                    ...
                    setTimeout(function(){
                        ...
                        //for regular process
                        $('#addReferenceModal').modal('hide');//hide modal
                    },1000);
