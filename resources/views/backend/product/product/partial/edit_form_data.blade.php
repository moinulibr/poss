                                ...
                                <div class="card mb-4">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="name" value="{{$variantDetails['name']}}"  class="form-control product_name" placeholder="Product Name" style="background-color:#ff4a00;color:#e2f7f6;font-weight:700;" />
                                                ...
                                                <div style="background-color:#252d3c;color:#e9ff30;padding:5px;margin-bottom:5px;margin-top:5px;">
                                                    <div class="form-row" >
                                                        <div class="form-group col-md-6">
                                                            ...
                                                            <input type="text"  value="{{$variantDetails['variant']}}"  name="product_variant" class="form-control product_variant product_variant_0" data-product_variant="0" placeholder="Product Variant"  style="border:1px solid #e2f7f6;background-color:whitesmoke;color:#150436;font-weight: 400;"/>
                                                            <div class="clearfix"></div>
                                                        </div>
                                                        <div class="form-group col-md-6">
                                                        ...
                                                        <div class="form-group col-md-12 product_name_with_variant_div product_name_with_variant_div_0" data-product_name_with_variant_div="0" style=";margin-bottom:-2px;margin-top:-8px;">
                                                            <strong style="color:red;">Product</strong> : <span class="product_name_with_variant_text product_name_with_variant_text_0" data-product_name_with_variant_text="0" style="color:yellow;font-size:12px;">{{$product->name}}</span>
                                                        </div>
                                                    </div>
                                                </div>
                                                <!--Product Variant--->
                                                ...
                                                <div style="background-color:brown;padding:5px;color:#fff;margin-bottom:5px;margin-top:5px;">
                                                    <div class="form-row">
                                                        <div class="form-group col-md-6">
                                                            ...
                                                            <select class="form-control addedNewColor_0 color_id color_id_0" data-color_id="0" name="color_id" style="color:yellow;background-color:#201c1c;">
                                                                <option value="" style="background-color:#fff;color:#1c1803;">Select Color</option>
                                                                @foreach ($colors as $item)
                                                                <option value="{{$item->id}}" {{$item->id == $product->color_id ? 'selected' : ''}} style="background-color:#fff;color:#1c1803;">{{$item->name}}</option>
                                                                @endforeach
                                                            </select>
                                                            <div class="clearfix"></div>
                                                        </div>
                                                ...
                                                <div style="background-color:rgb(12 143 143);padding: 5px;color:yellow;margin-bottom:5px;margin-top:5px;">
                                                    <div class="form-row">
                                                        <div class="form-group col-md-6">
                                                            ...
                                                            <input type="text"  value="{{ $product->custom_code }}"  class="form-control custom_code custom_code_0" data-custom_code="0" name="custom_code"  placeholder="AS Code" style="background-color:rgb(232, 240, 254);color:#030312;" />
                                                            <div class="clearfix"></div>
                                                        </div>
                                                        <div class="form-group col-md-6">
                                                            <label class="form-label">Company Code</label>
                                                            <input type="text"   value="{{ $product->company_code }}"  class="form-control company_code company_code_0" data-company_code="0" name="company_code"  placeholder="Company Code" style="background-color:rgb(232, 240, 254);color:#030312;" />
                                                            <div class="clearfix"></div>
                                                        </div>
                                                    </div>
                                                </div>
                                            ...
                                            <div style="background-color:#706a6a;padding: 5px;color:aliceblue;margin-bottom:5px;margin-top:5px;">
                                                <div class="form-row">
                                                    ...
                                                    <div class="form-group col-md-4">
                                                        ...
                                                        <input type="file" class="form-control photo photo_0" data-photo="0" name="photo" style="background-color:#deb887;color:#0000bf;" />
                                                        <div class="clearfix"></div>
                                                    </div>
                                                    <div class="form-group col-md-6">
                                                        <label class="form-label">Description</label>
                                                        <textarea cols="4" rows="1" class="form-control description description_0" data-description="0" name="description"  placeholder="Description" style="background-color:#deb887;color:#0000bf;" >{{ $product->description }}</textarea>
                                                        <div class="clearfix"></div>
                                                    </div>
                                                </div>
                                            </div>
