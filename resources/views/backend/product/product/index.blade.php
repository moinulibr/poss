                                    ...
                                    <div style="background-color:brown;padding:5px;color:#fff;margin-bottom:5px;margin-top:5px;">
                                        <div class="form-row">
                                            ...
                                            <div class="form-group col-md-3">
                                                ...
                                                <input type="text" class="form-control alert_stock alert_stock_${uniqueId}" data-alert_stock="${uniqueId}" name="alert_stock_${uniqueId}"  style="background-color:rgb(232, 240, 254);color:#030312;" placeholder="Alert Quantity" />
                                                <div class="clearfix"></div>
                                            </div>
                                        </div>
                                    </div>
