                ...
                <div class="row">
                    ...
                    <div class="col-12" style="padding-left: 20px;">
                        ...
                        <fieldset class="form-group mb-3 d-flex">
                            <input type="text" name="invoice_vat_amount" class="invoice_vat_amount form-control bg-white inputFieldValidatedOnlyNumeric" placeholder="Enter Vat" />
                            <span class="bg-light-dark  btn ml-2  pt-1 pb-1 d-flex align-items-center justify-content-center" style="width: 35%;">
                                <strong class="invoice_totoal_vat_amount">0</strong>
                            </span>
                        </fieldset>
